...
public class MagicRealTimeReader extends AbstractPagingItemReader<RealTimeDto> {
    ...
    protected void doReadPage() {
        ...
        if (getPageSize() * page > totalContentCount()) {
            ...
            List<Ranking> rankingRealTime = heroesRankingApiService.callMagicRankingRealTime(page);
